...
<html lang="ja">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-extend bg-warning text-right">
      <h1 class="display-4">Motoki's Portforio.</h1>
      <p class="lead">幕の内弁当的パフォーマンスメモリー</p>
      <hr class="my-4">
      <p>Please feel free to drop by.</p>
